...
def generate_baseline(model_name, input_csv_path, output_jsonl_path):
    ...
    if "Input" in baseline_df.columns:
        ...
        print("Error: 'Input' column not found in the CSV file.")
        return
...
def main():
    ...
    parser.add_argument(
        "--input_csv_path",
        type=str,
        default="/workspace/sandbox/medium-is-message/baseline_data/OncQA_Master.csv",
        help="Path to the input CSV file."
    )
    parser.add_argument(
        "--output_jsonl_path",
        type=str,
        default="/workspace/sandbox/mats9/data/llama3_oncqa_baseline_results.jsonl",
